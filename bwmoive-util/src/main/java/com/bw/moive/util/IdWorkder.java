...
public class IdWorkder {
    ...
    public IdWorkder(long idepoch) {
        this(r.nextInt((int) maxWorkerId), r.nextInt((int) maxDatacenterId), 0, idepoch);
    }

    public IdWorkder(long workerId, long datacenterId, long sequence) {
        this(workerId, datacenterId, sequence, 1344322705519L);
    }

    //
    public IdWorkder(long workerId, long datacenterId, long sequence, long idepoch) {
